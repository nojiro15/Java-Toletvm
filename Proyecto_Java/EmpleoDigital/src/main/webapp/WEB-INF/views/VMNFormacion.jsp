		...
		<hr size="1">
				...
				<legend>Nuevo Curso</legend>
						...
						<!-- Empieza formulario -->
							...
							<input type="hidden" name="idFormacion" value="${formacion.id}">
							<div class="row">
										...
										<fieldset>
							    			...
							    			<div class="col-md-6">
												    ...
												    <input name="nombre" type="text" class="textbox" id="nombre" value="${formacion.nombre}" />
													</div>
											</div>
										</fieldset>
										...
										<fieldset>
											...
											<div class="col-md-6">
												<div class="div_texbox">
											    		<input name="fechaInicio" type="text" class="textbox" id="fechaInicio" value="${stfechaInicio}"/>
